...
def main():
    ...
    bk_sector_betas = Bar(sector_betas,  plot_width=400, plot_height=400)
    ...
    bk_mc_betas = Bar(mktcap_betas, plot_width=400, plot_height=400)
    bk_mc_betas_script, bk_mc_betas_div = components(bk_mc_betas)

    # build market cap scatter plot
    scatter = Scatter(betalyzer.df_tickers, x='market_cap_log', y='beta', plot_width=400, plot_height=400)
    ...
    bk_history = Line(betalyzer.df_betas[top_tickers], plot_width=400, plot_height=400)
